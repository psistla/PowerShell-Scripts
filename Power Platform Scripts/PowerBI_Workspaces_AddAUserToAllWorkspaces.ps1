<#
This script will add a specific user to all workspaces with specified access.
#>
...
ForEach ($Workspace in $Workspaces) {
    try {
        Add-PowerBIWorkspaceUser -Scope Organization -Id $workspace.Id -UserEmailAddress "test@test.test" -AccessRight Admin
