...
$ExportBase = "C:\PowerPlatform\WWEX"
...
$Workspaces = Get-PowerBIWorkspace -Scope Organization -Skip 3 | where state -eq "Active" | where type -eq "Workspace"
...
ForEach ($workspace in $Workspaces)
    ...
    $logpath = $Folder + "\" + $workspace.Name.Trim() +".csv"
