...
param(
    ...
    [string] $JsonFile = 'PowerBIRefresh_Log_' + (Get-Date).ToString("yyy_MM_dd_hh_mm_ss") + '.json',

    [bool] $Csv = $true,

    [string] $CsvFile = 'PowerBIRefresh_Log_' + (Get-Date).ToString("yyy_MM_dd_hh_mm_ss") + '.csv',
