...
$connectionContainerSql.ConnectionDetails| Export-Csv -Path "C:\Temp\datasourcesObjectsSql.csv"
$connectionContainerExt.ConnectionDetails| Export-Csv -Path "C:\Temp\datasourcesObjectsExt.csv"
