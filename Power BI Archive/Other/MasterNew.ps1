...
$dssconfirm = Read-Host "Are you sure you want to proceed to generate Datasets"
if ($dssconfirm -eq 'y')
{
...
$reportsconfirm = Read-Host "Are you sure you want to proceed to generate Reports"
...
$dashconfirm = Read-Host "Are you sure you want to proceed to generate Dashboards"
if ($dashconfirm -eq 'y')
{
